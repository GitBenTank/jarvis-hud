...
| **Investor or advisor** | **Start:** `/docs/tati` or [investor-read-pack.md](strategy/investor-read-pack.md) — one path, plain-English glosses, ~15 min. Then [Demo](/demo). **Compressed lines:** [execution integrity messaging](strategy/messaging-execution-integrity.md). Deeper: [Gener8tor pitch](strategy/gener8tor-pitch.md) · [90s proof](video/90s-proof-demo.md) |
