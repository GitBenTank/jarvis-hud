...
- Keep **research batch v1** as the canonical first loop ([workflow](../strategy/research-batch-workflow-v1.md)); **external story** (one page: hero table, buyer line, proof checklist): [Research batch v1 — hero, buyer, proof](../strategy/research-batch-v1-hero-buyer-and-proof.md). **Activity UI** (queue-first transition, duplicate-then-cut): [Activity screen refactor v0](../strategy/activity-screen-refactor-spec-v0.md).
