...
- **v2+** — Specialist specs (e.g. [Research agent v1](./research-agent-v1.md), [Creative agent v1](./creative-agent-v1.md)) **by reference**; do not fork the consent model per agent.
