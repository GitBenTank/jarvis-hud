...
- **Buyer comprehension (external-ish pass):** run the [buyer-proof demo script](./research-batch-v1-buyer-proof-demo-pass.md) with 3–5 smart observers; log narrate-back friction in this [friction log](#friction-log-after-rehearsals).
