...
JARVIS_BASE_URL=http://127.0.0.1:3001 JARVIS_INGRESS_OPENCLAW_SECRET="..." pnpm jarvis:smoke
```
...
**Cut to:** Jarvis HUD browser window (http://127.0.0.1:3001)
...
- [ ] Jarvis running on http://127.0.0.1:3001
